  ...
  <AutoContainer>
    <TermsWrapper>
      ...
      <ul>
        ...
        <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kaira Luchi LLC, Ellicott City.</li>
        ...
        <li>Website refers to Kaira Luchi, accessible from https://www.kairaluchi.com</li>
      ...
      By accessing or using the Service You agree to be bound by these Terms and Conditions without limitation or qualification. If You disagree with any part of these Terms and Conditions then You are not allowed to use this Website and should immediately terminate such usage.
        Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.</p>
      <h3>Copyright</h3>
      <p>The copyright in all materials, features and functionality on the Site, including, but not limited to, text, graphics, videos, audio recordings, software, algorithms, artwork, interfaces, photographs, logos, icons, and images and the selection and arrangement thereof along with any enhancements to or derivative works thereto (collectively, "Content"), is the exclusive property of the Company or its licensors and is protected by U.S. and international laws. None of the Content shall be copied, reproduced, republished, uploaded, posted, transmitted, or distributed in any way, including, but not limited to, electronic, mechanical, photocopying, recording or otherwise, without the prior written consent of the Company, except that you may download, display, and print one copy of the materials on any single computer solely for your personal, non-commercial use, provided that you do not modify the material in any way and you keep intact all copyright, trademark, and other proprietary notices.</p>
      <h3>Trademark</h3>
      <p>The trademarks, service marks, logos and trade names (the "Trademarks") used and displayed on the Site, are registered and/or unregistered Trademarks of the Company. Nothing on the Site should be construed as granting any license or right to use any Trademark or any other of Our intellectual property displayed on the Site. The Trademarks and Trade Names belonging to the Company shall not be used in any way, including in advertising or publicity pertaining to distribution of Content on the Site, without prior written permission from Us and you shall not refer to or attribute any information to the Company or its licensors in any public medium for promotional or advertising purposes, or otherwise, or for the purpose of influencing a third party.</p>
      <h3>Users’ Comments</h3>
      <p>The Company does not assume any obligation to monitor the information that you may post on its website.
